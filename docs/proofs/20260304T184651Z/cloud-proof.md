...
- Session: `s_2e6f36c577fe541c`
- Endpoint: `wss://whatif-orchestrator-vgs7ulm4xa-uc.a.run.app/api/v1/session/s_2e6f36c577fe541c/live?user_id=smoke-user`
- Observed message types: `adk_event`, `output_transcript`, `audio_chunk`
- Raw JSON: `docs/proofs/live-ws-smoke-20260304T185139Z.json`
